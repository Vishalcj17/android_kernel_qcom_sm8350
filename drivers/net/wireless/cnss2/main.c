...
static ssize_t bdf_name_show(struct device *dev, struct device_attribute *attr,
			     char *buf)
{
...
static int cnss_probe(struct platform_device *plat_dev)
{
	...
	device_create_file(&plat_priv->plat_dev->dev, &dev_attr_bdf_name);
...
static int cnss_remove(struct platform_device *plat_dev)
{
	...
	device_remove_file(&plat_priv->plat_dev->dev,
			   &dev_attr_cnss_version_information);
	device_remove_file(&plat_priv->plat_dev->dev, &dev_attr_bdf_name);
